...
export default function GetFuture() {
    ...
    return (
        <>
            <div className="w-full lg:h-screen pt-20 lg:pt-50 pb-50 bg-[#F7FAFF] font-sans text-[#2e2e27] px-[10vw] flex flex-col md:flex-row items-start md:items-center justify-start md:justify-center lg:gap-38 gap-5 get-future-section" id="view_course">
