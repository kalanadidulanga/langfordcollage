...
function MostPopular() {
  ...
  return (
    <>
      {courses?.length > 0 && (
        <>
          <div className='w-full lg:h-screen lg:pb-10 bg-white text-black px-[10vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5' id='popular_course'>
