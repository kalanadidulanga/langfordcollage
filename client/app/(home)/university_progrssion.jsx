export default function UniProgession() {
    ...
    return (
        <div className="w-full pt-20 pb-20 bg-white text-[#2e2e27] px-[10vw] flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between lg:gap-32 gap-5">
            ...
            <div className="w-full flex items-start gap-6 flex-col description">
                <div className="w-full flex flex-col text-3xl md:text-[3.5vw]">
                    <span className="font-sans leading-none">University</span>
                    <span className="font-mono leading-[1.5]">Progression</span>
                </div>
                <div className="flex text-[20px]">
                    <li></li>
                    <a href="/business_progression" className="block px-4 text-gray-800  hover:pl-6 transition-all duration-200">Business progression courses</a>
                </div>
                <div className="flex text-[20px]">
                    <li></li>
