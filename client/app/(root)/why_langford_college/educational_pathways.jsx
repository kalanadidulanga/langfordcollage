...
export default function EducationalPathways() {
    return (<>
        <div
            className='w-full lg:h-screen font-sans pt-10 pb-20 bg-white text-black px-[10vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5 '>
