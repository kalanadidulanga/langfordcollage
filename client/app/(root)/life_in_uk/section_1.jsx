        ...
        <div
            ...
            <div className='w-full flex items-start flex-col lg:h-full'>
                ...
                <div
                    ...
                    <span className={`text-[16px]`}>
                        As a Langford College student, you’ll have the chance to complete your final year at one of our UK university partners, making the most of the UK’s outstanding higher education system while experiencing life in a new country.
                    </span>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div className='w-full flex items-start flex-col lg:h-full'>
                ...
                <div
                    ...
                    <div className='pl-5'>
                        <li>30% discounts on public transport (Railcards, Bus passes)</li>
                        <li>Exclusive savings at high street and online retailers via UNiDAYS or TOTUM</li>
                        <li>Special student meal plans and offers at cafes and restaurants</li>
                    </div>
                    <span className={`text-[16px]`}>
                        You’ll also find it easy to travel to Europe during your breaks!
                    </span>
                </div>
            </div>
        </div>
        <div
            ...
            <div className='w-full flex items-start flex-col lg:h-full'>
                ...
                <div
                    ...
                    <div className='pl-5'>
                        <li>Visa and CAS guidance</li>
                        <li>Final year university placement support</li>
                        <li>Accommodation advice</li>
                        <li>Pre-departure and arrival checklists</li>
                        <li>Cultural orientation webinars</li>
                    </div>
                </div>
            </div>
        </div>
