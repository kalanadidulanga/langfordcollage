    ...
    return (
        <>
            <div className='w-[100%] px-5 lg:px-32 capitalize'>
                <div className='w-full h-[35vh] mb-[20vh] flex justify-center items-center flex-col gap-5 lg:pl-36'>
                    ...
                    <div className='w-full flex flex-col text-center lg:text-start lg:pl-28'>
                        <span className='font-bold text-5xl md:text-[6vw] title2'>Langford College</span>
                    </div>
                </div>
