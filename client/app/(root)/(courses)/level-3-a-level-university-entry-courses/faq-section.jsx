...
function FAQ() {
    ...
    return (
        <>
            <div className='w-full capitalize font-sans lg:pb-10 bg-white text-black px-[10vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5'>
