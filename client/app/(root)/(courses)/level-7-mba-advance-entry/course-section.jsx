...
function CourseSection() {
  ...
  const loadCourses = async () => {
    ...
    try {
      const res = await axios.post(`${BASE_URL}/api/serchCourseByLevel`, {
        course_level: "Level 7 Diploma, Masters / MBA Advance Entry"
      });
  ...
  return (
    <>
      {courses?.length > 0 ? (
        <>
          <div className='w-full lg:pb-10 capitalize bg-white text-black px-[10vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5 course-section'>
