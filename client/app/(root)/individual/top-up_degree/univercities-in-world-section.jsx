...
function UnivercitiesInWorld() {
    ...
    return (
        <>
            <div className='w-full lg:pb-5 font-sans bg-white text-black px-[9vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5 uni-section '>
                <div className='w-full flex items-start font-bold flex-col lg:h-full uni-left'>
                    ...
                    <div className='w-full bg-white text-[16px] description text-[#2E2E27] lg:pb-16 pb-5'>
            ...
            <div className='flex pb-20 font-sans flex-col description bg-white text-[#2E2E27] text-[16px] font-extralight px-[9vw] gap-3 uni-section1 '>
