...
function HowTopupDegreeWork() {
  ...
  return (
    <>
      <div className='w-full font-sans bg-white pt-20 text-black px-[9vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5 howtopup-section '>
      ...
      <div className='w-full bg-white pb-20 px-[10vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5 howtopup-section '>
        <div className='flex items-start justify-start w-full howtopup-left'>
          <button className='btn bg-[#E2231A] hover:bg-[#ff0000] hover:shadow-md shadow-[#e2241aa6] ' onClick={() => {
