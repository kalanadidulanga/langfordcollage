...
function Progression() {
    ...
    return (
        <>
            <div className='w-full lg:pb-10 pt-5 bg-white text-black px-[10vw] flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5'>
                    ...
                    {isclickSection1 && (
                        <>
                            <div className='w-full bg-white pb-8 text-[#2E2E27] font-extralight text-[16px] flex justify-between'>
                                <span>
                                The OBS programmes are mapped against UK higher education qualifications which are fully transferable to a range of other higher education routes and professional qualifications. On completion of the OBS level 4/5 programme students will be awarded 240 credits (The first 2 years of a undergraduate degree) . They can then top up to their final year at one of our university partners who recognise the qualification. Similarly at level 7 students gain 120 credits from a total of 180 credits for an MBA. Again they can top up at an OBS university partner.
                                </span>
                            </div>
                        </>
                    )}
