...
function SingleViewBody() {
    return (
        <>
            <div className='w-full flex flex-col gap-10 pt-10 pb-20 bg-white text-black'>
                <div className='w-full bg-white pt-20 px-[10vw] text-black flex flex-col lg:flex-row items-start justify-start lg:justify-between lg:gap-32 gap-5'>
                ...
                <div className='w-full bg-[#F7FAFF] px-[10vw] flex flex-col gap-10 p-10'>
                    <div className='w-full flex flex-col gap-5'>
                        <span className='font-bold md:text-[1.5vw]'>
                            The Positive Impact of Online Business School in Malta
                        </span>
                        <span className='text-[18px] font-extralight text-[#2E2E27]'>
                    ...
                    <div className='w-full flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col text-[#2E2E27]'>
