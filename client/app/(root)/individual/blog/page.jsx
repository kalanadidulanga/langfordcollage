...
function page() {
  ...
  if (isClient) {
    return (
      <>
          <Head>
              <title>Langford College | Blog</title>
              ...
              <meta property="og:url" content="https://langfordcollege.com/individual/blog"/>
              <meta name="viewport" content="width=device-width, initial-scale=1.0" />
              <link rel="canonical" href="https://langfordcollege.com/individual/blog"/>
          </Head>
