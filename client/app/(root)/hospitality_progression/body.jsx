                ...
                <div className='w-full flex items-start flex-col lg:h-full'>
                    <div className="w-full lg:grid lg:grid-cols-2">
                        <div className="w-full flex items-start flex-col font-sans lg:h-full">
                            ...
                            <span className='text-[8vw] lg:text-[3.6vw] font-mono leading-[1.3]'>
                                Pathways
                            </span>
                        </div>
                        ...
                        {isclickSection1 && (
                            <>
                                <div className='flex flex-col gap-2 description2 text-[14px] lg:text-[16px] lg:description'>
                                    ...
                                    <div className='pl-5'>
                                        <li className='description2 text-[14px] lg:text-[16px] lg:description'>University of Bolton</li>
                                        <div className='pl-5 mt-2'>
                        ...
                        {isclickSection2 && (
                            <>
                                <div className='flex flex-col gap-2 description2 text-[14px] lg:text-[16px] lg:description'>
                                    ...
                                    <div className='pl-5'>
                                        <li className='description2 text-[14px] lg:text-[16px] lg:description'>Bournemouth University</li>
                                        <div className='pl-5 mt-2'>
                                    ...
                                    <div className='pl-5'>
                                        <li className='description2 text-[14px] lg:text-[16px] lg:description'>University of Sunderland</li>
                                        <div className='pl-5 mt-2'>
                                            <li>International Tourism and Hospitality Management (Top-Up) BSc (Hons)</li>
                                        </div>
                                    </div>
                                    <div className='pl-5'>
                                        <li className='description2 text-[14px] lg:text-[16px] lg:description'>University of Northampton</li>
                                        <div className='pl-5 mt-2'>
                                            <li>International Tourism Management (Top-Up) BA</li>
                                        </div>
                                    </div>
                                    <div className='pl-5'>
                                        <li className='description2 text-[14px] lg:text-[16px] lg:description'>Middlesex University London</li>
                                        <div className='pl-5 mt-2'>
