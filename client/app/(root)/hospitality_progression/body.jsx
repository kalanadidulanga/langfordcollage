            ...
            <div
                ...
                <div className='w-full flex items-start flex-col lg:h-full'>
                    ...
                    <div
                        ...
                        <div className='pl-5'>
                            <li className='font-bold'>Bournemouth University</li>
                            <div className='pl-5 mt-2'>
                                <li>BA (Hons) International Hospitality & Tourism Management</li>
                            </div>
                        </div>
                        <div className='pl-5'>
                            <li className='font-bold'>University of Central Lancashire</li>
                            <div className='pl-5 mt-2'>
                        ...
                        <div className='pl-5'>
                            <li className='font-bold'>University of Northampton</li>
                            <div className='pl-5 mt-2'>
                                <li>International Tourism Management (Top-Up) BA </li>
                            </div>
                        </div>
                        <div className='pl-5'>
                            <li className='font-bold'>Middlesex University London</li>
                            <div className='pl-5 mt-2'>
