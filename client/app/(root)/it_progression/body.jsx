                            ...
                            <>
                                <div className='flex flex-col gap-2 description2 text-[14px] lg:text-[16px] lg:description'>
                                    <div
                                        ...
                                        <div className='pl-5'>
                                            <li className='description2 text-[14px] lg:text-[16px] lg:description'>University of Hertfordshire </li>
                                            <div className='pl-5 mt-2'>
                                                <li>BSc Honours Information Technology top up</li>
                                            </div>
                                        </div>
                                        <div className='pl-5'>
                                            <li className='description2 text-[14px] lg:text-[16px] lg:description'>University of Huddersfield</li>
                                            <div className='pl-5 mt-2'>
                            ...
                            <>
                                <div className='flex flex-col gap-2'>
                                    <div
                                        ...
                                        <div className='pl-5'>
                                            <li className='description2 text-[14px] lg:text-[16px] lg:description'>Middlesex University</li>
                                            <div className='pl-5 mt-2 description2 text-[14px] lg:text-[16px] lg:description'>
                                                <li>BSc Information Systems (Top-up) </li>
                                                <li>BSc (Hons) Information Technology and Business Information Systems (Top-up)</li>
                                            </div>
                                        </div>
                            ...
                            <>
                                <div className='flex flex-col gap-2 description2 text-[14px] lg:text-[16px] lg:description'>
                                    <div
                                        ...
                                        <div className='pl-5'>
                                            <li className='description2 text-[14px] lg:text-[16px] lg:description'>University of Roehampton</li>
                                            <div className='pl-5 mt-2'>
