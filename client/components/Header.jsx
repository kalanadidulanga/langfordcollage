          ...
          <div className="flex flex-col p-4 space-y-2">
                ...
                <div className="pl-4 py-2 space-y-4">
                  <div>
                    ...
                    <div className="flex flex-col pl-2">
                      {level1?.map((item, index) => (
                        <a href={`/course/${item?.slug}`} key={index} className="py-1 text-gray-800 hover:text-red-600">
                          {item?.course_name}
                        </a>
                      ))}
                    </div>
                  ...
                  <div>
                    <h3 className="font-bold mb-2">Level 4 & 5 - University first and second year courses</h3>
                    <div className="flex flex-col pl-2">
                      {level3?.map((item, index) => (
                        <a href={`/course/${item?.slug}`} key={index} className="py-1 text-gray-800 hover:text-red-600">
                          {item?.course_name}
            ...
            <div className="border-b border-gray-200 pb-2">
              ...
              >
                <div className="pl-4 py-2">
                  <div className="flex flex-col">
                    <a href="/individual/how_will_you_learn" className="block py-1 text-gray-800  hover:pl-4 transition-all duration-200">How will you learn</a>
                    <a href="/individual/our_hubs" className="block py-1 text-gray-800  hover:pl-4 transition-all duration-200">Our Hubs</a>
                    <a href="/individual/top-up_degree" className="block py-1 text-gray-800  hover:pl-4 transition-all duration-200">Top up degree</a>
                    <a href="/individual/blog" className="block py-1 text-gray-800  hover:pl-4 transition-all duration-200">Blog</a>
                    <a href="/individual/testimonial" className="block py-1 text-gray-800 hover:pl-4 transition-all duration-200">Testimonial</a>
                  </div>
                </div>
              </div>
            </div>
